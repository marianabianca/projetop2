 ...
 * entao o objetivo desses testes eh de apenas testar a funcionalidade das
 * classes.
 * 
 * @author Julio Costa
 *
...
public class ProjetosTest {
	...
	@Before
	public void setUp() {
		monitoria = new ProjetoMonitoria("Monitoria", "Laboratorio de Programacao 1", 50,
				"Ajudar os alunos que cursam a disciplina", "2016.2", "12/12/2016", 6, "000000");
		extensao = new ProjetoExtensao("Extensao",
				"Levar conhecimento da universidade para fora dela, ajudando a comunidade no geral", 4, "01/01/2016",
				12, "000001");
		ped = new ProjetoPED("P&D", "Desenvolvimento", 9, 7, 5, "ganhar dinheiro", "01/01/01", 12, "000002");
		pet = new ProjetoPET("Programa de educacao tutorial", "Ajudar na graduacao", 5, 80, 8, 8, 2, "01/01/16", 12,
				"000003");
		d1 = new Despesa(500);
	}
	...
	public void testEquals() {
		...
		Projeto proj = new ProjetoMonitoria("Monitoria", "Laboratorio de Programacao 1", 50,
				"Ajudar os alunos que cursam a disciplina", "2016.2", "12/12/2016", 6, "000000");
